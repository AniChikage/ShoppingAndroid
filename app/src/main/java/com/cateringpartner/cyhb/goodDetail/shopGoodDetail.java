...
public class shopGoodDetail extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.good_detailshop);
        ...
        */
        ...
        tv_shop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent();
                intent.setClass(shopGoodDetail.this, GoodByCompany.class);
                startActivity(intent);
                //finish();
            }
        });
                ...
                for (int i = 0; i < arr.length(); i++) {
                    ...
                    try{
                        ...
                        for(int ii=0;ii<Integer.valueOf(temp.getJSONObject("allGoods").getString("goodintroimgnum"));ii++){
                            ImageView imageView = new ImageView(shopGoodDetail.this);
                            Glide.with(shopGoodDetail.this)
